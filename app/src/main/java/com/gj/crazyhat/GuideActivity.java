...
public class GuideActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ((ImageView)view1.findViewById(R.id.tv_pic)).setImageResource(R.drawable.guide_page_one);
        ((ImageView)view2.findViewById(R.id.tv_pic)).setImageResource(R.drawable.guide_page_two);
        ((ImageView)view3.findViewById(R.id.tv_pic)).setImageResource(R.drawable.guide_page_three);
        ...
        ((TextView)view3.findViewById(R.id.tv_title)).setText("疯狂帽子");
        ((TextView)view3.findViewById(R.id.tv_title)).setTextColor(Color.parseColor("#16c5c6"));

        ((TextView)view1.findViewById(R.id.tv_desc)).setText("疯狂帽子第一时间为你奉上\n");
